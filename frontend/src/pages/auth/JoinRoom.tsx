    ...
    <>
      {showForm ? (
        ...
        <div className="flex flex-col items-center gap-6 sm:gap-8 px-4">
          ...
          <div className="fixed bottom-2 right-2 sm:right-5 bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-2xl border-2 border-orange-400 py-0 px-2 sm:p-6 min-w-[200px] sm:min-w-[280px] max-w-[90vw] sm:max-w-none">
